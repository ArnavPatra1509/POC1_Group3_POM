...
public html_page(WebDriver dr)
{
	...
	{
		arr1=((ArrayList<WebElement>)dr.findElements(xp1));// gets the bok and price together
		for(WebElement s1:arr1)
		{
			int index=s1.getText().indexOf('$');
			arr2.add(s1.getText().substring(index));// gets the price 
		}	
		return arr2;	
	}
